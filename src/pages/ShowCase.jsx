  ...
  <div className="flex gap-16">
    <div className="w-1/2">
      ...
      <p className="text-gray-500 text-sm font-semibold mb-8">
        Everything You Need to Know to Start and <br/> Grow Your POD Business in the Canadian Market.
      </p>
    ...
    <div className="w-1/2 flex flex-col gap-4">
      <div className="bg-green-50 rounded-xl p-6">
        ...
        <p className="text-gray-600 text-sm font-medium">
          Upload your art or use our intuitive design tools to make standout products your audience will love.
        </p>
      </div>
      <div className="bg-red-50 rounded-xl p-6">
        ...
        <p className="text-gray-600 text-sm font-medium">
          Connect your store to Shopify, WooCommerce, or your favourite platform, all with seamless integrations.
        </p>
      </div>
      <div className="bg-purple-50 rounded-xl p-6">
        ...
        <p className="text-gray-600 text-sm font-medium">
          Once your designs are ready, add the products to your store. Set your prices the way you want. Everything stays simple and clear in Canadian dollars. No complicated steps. No confusion.
        </p>
      </div>
      <div className="bg-yellow-50 rounded-xl p-6">
        ...
        <p className="text-gray-600 text-sm font-medium">
          Before going live, you can order samples to check the print and quality yourself. When you're happy, launch your store. Start selling to your customers.
        </p>
      </div>
    </div>
  </div>
...
<section className="px-16 py-16 bg-gray-50">
  ...
  <div className="grid grid-cols-3 gap-8">
    ...
    <div className="bg-white rounded-xl p-8">
      <img src="" alt="creators" className="rounded-lg w-full mb-6" />
      <h3 className="font-bold text-gray-900 text-lg mb-3">For Creators</h3>
      <p className="text-gray-600 text-sm font-semibold mb-6">
       Creators can turn their ideas into real products. No need to 
       take tension about printing or shipping.Just create and sell.
       the rest is handled for you.
      </p>
      <button className="border border-yellow-400 text-yellow-500 font-semibold px-5 py-2 rounded hover:bg-yellow-400 hover:text-black text-sm">
        Start Selling Your Designs
      </button>
    </div>

    <div className="bg-white-400 rounded-xl p-8">
      <img src="" alt="businesses" className="rounded-lg w-full mb-6" />
      ...
      <p className="text-gray-800 text-sm font-semibold mb-6">
        Small and medium businesses can grow without pressure. 
        You don’t have to store products or manage stock.
        Custom items are made only when someone orders.
        It keeps things simple and stress-free.
      </p>
      <button className="bg-yellow-400 text-white font-semibold px-5 py-2 rounded hover:bg-yellow-600 text-sm">
        Start Your Store Today
      </button>
    </div>

    <div className="bg-white rounded-xl p-8">
      <img src="" alt="brands" className="rounded-lg w-full mb-6" />
